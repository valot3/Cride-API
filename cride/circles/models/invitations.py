#codigo, quien emitio la invitacion, quien uso la invitacion, si se a usado o no
...
#Project
from cride.utils import CRideModel
...
class Invitation(CRideModel):
    ...
    of the circle and have a `ramaining_invitations` value
    grater than 0.
    """
