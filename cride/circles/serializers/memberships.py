...
class AddMemberSerializer(serializers.Serializer):
    ...
    Handle the addiotion of a new member to a circle.
    ...
    def validate_user(self, data):
        ...
        if q:   #If q == True
            raise serializer.ValidationError('User ir already member of this circle')
    ...
    def validate(self, data):
        """
        Verify circle if capable of accepting a new member.
        """
        circle = self.context['circle']
    ...
    def create(self, data):
        ...
        #Update issuer data
        issuer = Membership.objects.get(user=invitation.issued_by, circle=circle, is_active=True)
