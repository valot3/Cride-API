# Generated by Django 3.1.1 on 2021-08-14 21:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'The email entered is already in use.'}, max_length=254, unique=True, verbose_name='email address')),
                ...
                ('is_client', models.BooleanField(default=True, help_text='Help easily distinguish users and perform queries.Clients are the main types of user.', verbose_name='client status')),
                ('is_verified', models.BooleanField(default=False, help_text='Set to true when the user have verified its email address.', verbose_name='verified status')),
